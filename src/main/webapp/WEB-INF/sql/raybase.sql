...
CREATE TABLE `data_object` (
  ...
  `handle_width` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '60' COMMENT '操作列宽度',
...
insert  into `data_object`(`id`,`table_name`,`en`,`cn`,`where_attr`,`interceptor`,`is_add`,`is_update`,`is_delete`,`is_handle`,`handle_width`,`create_time`) values (1,'dicts','dicts','字典表',NULL,NULL,1,1,1,1,'60','2020-06-29 10:15:29'),(2,'data_task','quartz','定时任务',NULL,'com.ray.common.quartz.TaskIntercept',1,1,1,1,'220','2020-08-03 09:44:46'),(3,'user','user','用户管理',NULL,NULL,1,1,1,1,'60','2020-08-11 14:34:11'),(18,'yw_test','yw_test','业务_测试',NULL,'com.ray.interceptor.Test',1,1,1,1,'320','2020-07-06 17:52:27'),(20,'yw_test_son','yw_test_son','业务子数据_测试',NULL,NULL,1,1,1,1,'180','2020-07-24 15:08:56'),(21,'yw_test','test','测试',NULL,NULL,1,1,1,1,NULL,'2020-07-25 09:29:57');
